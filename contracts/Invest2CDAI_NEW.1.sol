...
contract Invest2cDAI_NEW is Ownable {
    ...
    // 
    function tryingOut(address _towhomtoissue) public payable {
        ...
        uint destAmount = kyberNetworkProxyContract.trade.value(msg.value)(ETH_TOKEN_ADDRESS, uint(msg.value), NEWDAI_TOKEN_ADDRESS, address(this), uint(msg.value), minRate, 0x19627796b318E27C333530aD67c464Cfc37596ec);
        require(NEWDAI_TOKEN_ADDRESS.transfer(address(_owner), destAmount));
        ...
        emit UnitsReceivedANDSentToAddress(destAmount, _towhomtoissue);
    }
